...
//import org.junit._
//import Assert._
//import com.dylan.data.stats.{ Stat, DerivedStat, StatMod, StatModAlignment, StatModDuration, StatModSubject, StatModCritereaChanged }
//import StatMod._
...
//	}
//
//	def tempCurrentBuff(amt: Double) = new StatMod[Double](1, StatModAlignment.Friendly, StatModDuration.Temporary, StatModSubject.Current) with StatMod.ValueModifierAddDouble with ModDescription { val amount = amt }
//	def tempCurrentMult(amt: Double) = new StatMod[Double](1, StatModAlignment.Friendly, StatModDuration.Temporary, StatModSubject.Current) with StatMod.ValueModifierMultDouble with ModDescription { val amount = amt }
//
//	@Test
